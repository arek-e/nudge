...
>(({ className, ...props }, ref) => (
  <Overlay
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0  bg-overlay-scrim/80 fixed inset-0 z-50",
      className,
    )}
    {...props}
    ref={ref}
