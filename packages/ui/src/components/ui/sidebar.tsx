...
type SidebarStyle = CSSProperties & {
  ...
  readonly "--sidebar-width-icon"?: string;
    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            style={sidebarProviderStyle(style)}
            className={cn(
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            style={sidebarWidthStyle(SIDEBAR_WIDTH_MOBILE)}
            side={side}
          >
  ...
  return (
    ...
    >
      ...
      <Skeleton
        ...
        style={sidebarSkeletonStyle(width)}
      />
    </div>
  );
});
...
function sidebarProviderStyle(style: CSSProperties | undefined): SidebarStyle {
  return {
...
function sidebarWidthStyle(width: string): SidebarStyle {
  return {
    "--sidebar-width": width,
  };
}

function sidebarSkeletonStyle(width: string): SidebarStyle {
  return {
