/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe4ff6de215fb5e0adbb51ce88d5d6a5)
...
interface __BaseEnv_Env {
  ...
  CLERK_AUTHORIZED_PARTIES:
    | "https://app.staging.explorenudge.com,https://nudge-web-staging.teampitch.workers.dev"
    | "https://app.explorenudge.com,https://nudge-web.teampitch.workers.dev"
    | "http://localhost:8787,https://app.explorenudge.com,https://nudge-web.teampitch.workers.dev";
  CLERK_PUBLISHABLE_KEY:
    | "pk_test_cmVuZXdlZC1zZWFzbmFpbC0zOC5jbGVyay5hY2NvdW50cy5kZXYk"
    | "pk_live_Y2xlcmsuYXBwLmV4cGxvcmVudWRnZS5jb20k"
    | "pk_test_dWx0aW1hdGUta2l3aS05Mi5jbGVyay5hY2NvdW50cy5kZXYk";
  CONVEX_URL:
    | "https://abundant-retriever-130.eu-west-1.convex.cloud"
    | "https://friendly-lion-904.eu-west-1.convex.cloud"
  ...
  DAILY_DIGEST_WORKFLOW: Workflow<
    Parameters<import("./src/index").DailyDigestWorkflow["run"]>[0]["payload"]
  >;
}
