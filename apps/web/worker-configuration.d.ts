/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f3188ba54e02836c0503cd93fd4e5844)
...
interface __BaseEnv_Env {
	...
	APP_VERSION: "0.0.0";
	CLERK_AUTHORIZED_PARTIES: "https://vesta-web-staging.teampitch.workers.dev" | "https://vesta-web.teampitch.workers.dev" | "http://localhost:8787,https://vesta-web.teampitch.workers.dev";
	CLERK_PUBLISHABLE_KEY: "pk_test_cmVuZXdlZC1zZWFzbmFpbC0zOC5jbGVyay5hY2NvdW50cy5kZXYk" | "pk_test_dWx0aW1hdGUta2l3aS05Mi5jbGVyay5hY2NvdW50cy5kZXYk";
	LOG_HTTP_REQUESTS: "true";
	EXTRACTION_MODEL: "@cf/zai-org/glm-4.7-flash";
	THINK_MODEL: "@cf/moonshotai/kimi-k2.7-code";
	TURBOPUFFER_REGION: "aws-eu-west-1";
	USER_AGENT_SESSION: DurableObjectNamespace<import("./src/index").UserAgentSession>;
	LoopIntakeThinkAgent: DurableObjectNamespace<import("./src/index").LoopIntakeThinkAgent>;
	OKF_SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
	DAILY_DIGEST_WORKFLOW: Workflow<Parameters<import("./src/index").DailyDigestWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserAgentSession" | "LoopIntakeThinkAgent" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_VERSION" | "CLERK_AUTHORIZED_PARTIES" | "CLERK_PUBLISHABLE_KEY" | "LOG_HTTP_REQUESTS" | "EXTRACTION_MODEL" | "THINK_MODEL" | "TURBOPUFFER_REGION">> {}
}
