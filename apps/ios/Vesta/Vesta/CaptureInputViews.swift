...
struct VestaShimmeringText: View {
    let text: String
    let font: Font
    let textColor: Color
    ...
    private func beginRecording() {
        do {
            ...
            let url = FileManager.default.temporaryDirectory
                .appendingPathComponent("vesta-voice-\(UUID().uuidString).m4a")
...
extension UIImage {
    func vestaScaled(maxDimension: CGFloat) -> UIImage {
    ...
    func vestaPreparedForUpload(maxDimension: CGFloat) -> UIImage {
        vestaWithWhiteBackground().vestaScaled(maxDimension: maxDimension)
    }

    func vestaWithWhiteBackground() -> UIImage {
