    ...
    private func beginRecording() {
        do {
            ...
            let url = FileManager.default.temporaryDirectory
                .appendingPathComponent("lares-voice-\(UUID().uuidString).m4a")
...
extension UIImage {
    func laresScaled(maxDimension: CGFloat) -> UIImage {
    ...
    func laresPreparedForUpload(maxDimension: CGFloat) -> UIImage {
        laresWithWhiteBackground().laresScaled(maxDimension: maxDimension)
    }

    func laresWithWhiteBackground() -> UIImage {
