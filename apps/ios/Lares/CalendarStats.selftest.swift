...
enum CalendarStatsSelftest {
    static func main() {
        ...
        assert(LaresChromeAction.todayCalendar.destination == .todayCalendar)
        assert(LaresChromeAction.todayCalendar.sheet == nil)
        assert(LaresChromeAction.streakCalendar.destination == nil)
        assert(LaresChromeAction.streakCalendar.sheet == .streakCalendar)
    }
}
