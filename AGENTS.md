...
Before changing app runtime layers, service seams, or module ownership, read `docs/architecture/layers-and-services.md`. It records what Lares borrows from `pingdotgg/t3code` and what we intentionally do not copy.
